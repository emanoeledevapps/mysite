  ...
  return (
    <>
      <header className="flex flex-col container mx-auto py-10 px-5">
        <h1 className="text-4xl">Soccer Bolão - Política de privacidade</h1>
      </header>

      <main className="mt-10 flex flex-col container mx-auto px-5">
        <p>Última atualização: 25 de março de 2025</p>
        <h2 className="mt-10">A sua privacidade é importante para nós. Esta Política de Privacidade tem como objetivo explicar como coletamos, usamos, protegemos e compartilhamos seus dados pessoais ao usar o aplicativo Soccer Bolão.</h2>
