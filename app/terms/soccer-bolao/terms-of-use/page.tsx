  ...
  return (
    <>
      <header className="flex flex-col container mx-auto py-10 px-5">
        <h1 className="text-4xl">Soccer Bolão - Termos de uso</h1>
      </header>

      <main className="mt-10 flex flex-col container mx-auto px-5">
        <p>Última atualização: 25 de março de 2025</p>
        <h2 className="mt-10">Estes Termos de Uso regem sua utilização do aplicativo Soccer Bolão. Ao usar o aplicativo, você concorda com estes Termos.</h2>
