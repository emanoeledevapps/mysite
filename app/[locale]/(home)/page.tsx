      ...
      <main className="flex min-h-screen flex-col items-center pb-20 bg-black">
        <div className="w-full lg:w-[1024px] flex flex-col mt-32">
          <div className="flex flex-col w-full items-center px-2 lg:px-0">
            <h1 className="text-white font-bold text-4xl text-center lg:w-[60%]">
              Olá, me chamo Emanoel Augusto e sou Desenvolvedor Front-End
            </h1>
          ...
          <h3 className="mt-20 text-white font-bold ml-2 lg:ml-0">
          ...
          <section className="flex overflow-x-auto gap-5 w-full px-2 lg:px-0">
            ...
            <div className="flex flex-col items-center justify-center w-[200px]">
              ...
              <p className="text-white text-center">
                Mais projetos por aqui em breve...
              </p>
            </div>
          </section>

          <h3 className="mt-20 text-white font-bold ml-2 lg:ml-">
