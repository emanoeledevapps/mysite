...
export async function EmphasisProjects({ locale, t }: Props) {
  ...
  return (
    <section className="flex flex-col gap-1 mb-10 lg:mb-20 w-full">
      <h3 className="text-primary">{t("home.emphasisProjects")}</h3>
...
function ProjectItem({ project }: ProjectItemProps) {
  return (
    <Link
      ...
      className="rounded-2xl flex gap-3 bg-card w-full overflow-hidden"
    >
